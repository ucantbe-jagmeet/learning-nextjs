        ...
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap justify-center">
              { Object.keys(products).length === 0 && <p className='font-semibold'> Sorry all the mugs Are out of Stock, Stay Tuned...!!!!!<span className='text-3xl'>🥲</span></p> }
...
{/* <img alt="ecommerce" className="h-[30vh] mx-auto md:h-[36vh] block" src="https://m.media-amazon.com/images/I/51H5aeESVyL._AC_UL480_FMwebp_QL65_.jpg" /> */}